...
<div class="container mt-5 fadeOn" id="career">
    ...
    <div class="owl-carousel owl-2">
        ...
        <div class="media-29101">
            ...
            <h3 class="mb-1 mt-1"><a href="#">Les tendances CV du moment</a></h3>
            <p class="mt-0">Le CV est le premier contact entre le candidat et le recruteur mais il se limite plus à un
                document qui
        ...
        <div class="media-29101">
            ...
            <h3 class="mb-1 mt-1"><a href="#">5 conseils pour réussir un entretien vidéo</a></h3>
        ...
        <div class="media-29101">
            ...
            <h3 class="mb-1 mt-1"><a href="#">Convaincre quand on est jeune diplômé</a></h3>
        ...
        <div class="media-29101">
            ...
            <h3 class="mb-1 mt-1"><a href="#">Senior : CV par compétence ou expérience ?</a></h3>
        ...
        <div class="media-29101">
            ...
            <h3 class="mb-1 mt-1"><a href="#">Comment bien gérer le télétravail ?</a></h3>
            <p class="mt-0">A l’issue du confinement, moult études se sont succédé pour interroger les salariés sur leur appréciation
                du télétravail, une pratique inédite pour nombre d’entre eux. Si en 2018, seulement 3% des salariés
                français télétravaillaient de façon encadrée, un sondage Odaxa du 9 avril révélait qu’à la fin mars, 24...</p>
        </div>
