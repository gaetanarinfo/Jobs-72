...
@section('title', '- Editer l\'article')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center mt-3 mb-3">
                <h1>Editer l'article - {{ $news->title }}</h1>
                <hr />
            </div>
        </div>
    </div>
                                        ...
                                        <div class="card" style="width: 605px !important;">
                                            ...
                                            <div class="card-body">
                                                <form method="POST" enctype="multipart/form-data"
                                                    action="{{ route('news_update_post', $news->id) }}">
                                                    @csrf

                                                    <div class="form-group row">
                                                        <label for="name"
                                                            class="col-md-6 col-form-label text-md-right">{{ __('Titre de l\'article') }}</label>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="email"
                                                            class="col-md-6 col-form-label text-md-right">{{ __('Catégorie de l\'article') }}</label>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="smallContent"
                                                            class="col-md-12 col-form-label text-md-right">{{ __('Courte description de l\'article') }}</label>
                                                        ...
                                                        <div class="col-md-12">
                                                            <textarea id="smallContent"
                                                                ...
                                                                style="height: 133px;">{{ $news->smallContent }}</textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="content"
                                                            class="col-md-12 col-form-label text-md-right">{{ __('Description de l\'article') }}</label>

                                                        <div class="col-md-12" style="height: 100%">
                                                            <textarea id="content"
                                                                class="form-control @error('content') is-invalid @enderror"
                                                                name="content" required
                                                                style="height: 250px;">{{ $news->content }}</textarea>
