                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="https://jobs-72.com/"
                                ...
                                <img src="https://jobs-72.com/logo.png" style="width: 144px;" />
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            ...
                                            Bonjour {{ $name }} !</h1>
                                        <p
                                            style="margin: 30px auto; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Génial, Votre devis à été accepter !</p>
                                                            ...
                                                            <td align="center"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                                            <p>Nous reviendrions vers vous au plus vite
                                                                                pour faire le point sur vos besoins.</p>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
